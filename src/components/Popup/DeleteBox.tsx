  ...
  return (
    <Modal open={open} onClose={handleCloseModal}>
      <div className="w-full flex-col text-center flex items-center
          justify-center">
        <div className="mx-auto my-5 flex-shrink-0 flex items-center
            justify-center h-12 w-12 rounded-full bg-red-100 sm:mx-0 sm:h-10
            sm:w-10">
          <svg
      ...
      <div className="w-full flex flex-row py-3 lg:items-end lg:justify-end
          items-center justify-center flex-wrap gap-1">
        <Button
          margin={1.5}
          bgColor="black"
          size="base"
